      ...
      {isRightVisible && <div className="absolute right-0 top-1/2 -translate-y-1/2 bg-gradient-to-l from-white from-50% to-transparent w-24 h-full flex justify-end">
        <Button 
          ...
          onClick={() => {
              ...
              const newTranslate = translate + TRANSLATE_AMOUNT
              const edge = containerRef.current.scrollWidth // untuk mengetahui panjang scroll-able div
              const width = containerRef.current.clientWidth // untuk mengetahui panjang div yang ditampilkan di screen
              
              // untuk mengetahui apakah posisi saya melebihi scroll-able div yang ada melebihi screen?
